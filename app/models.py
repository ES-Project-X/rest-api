...
class User(Base):
    ...
    image_url = Column(String, default="https://project-x-storage.s3.eu-west-1.amazonaws.com/default-avatar.jpg", unique=True)
...
class UserPOI(Base):
    ...
    existence_cooldown = Column(DateTime, nullable=True)
